...
// SystemChannelTestTokenId marks consume logs generated by channel diagnostics.
// It is deliberately non-positive so token usage reports continue to ignore it.
const SystemChannelTestTokenId = -1
