...
export const STATIC_I18N_KEYS = [
  ...
  'statusCenter.status.outage',
  'statusCenter.status.unknown',
  'statusCenter.status.maintenance',
  'statusCenter.tabs.overview',
  'statusCenter.tabs.incidents',
  'statusCenter.tabs.maintenance',
  'statusCenter.tabs.subscribers',
  'statusCenter.tabs.deliveries',
  'statusCenter.tabs.settings',
  'statusCenter.tabs.audit',
  'statusCenter.incidents.state.investigating',
  'statusCenter.incidents.state.identified',
  'statusCenter.incidents.state.monitoring',
  'statusCenter.incidents.state.resolved',
  'statusCenter.recordStatus.draft',
  'statusCenter.recordStatus.private',
  'statusCenter.recordStatus.public',
  'statusCenter.recordStatus.pending',
  'statusCenter.recordStatus.active',
  'statusCenter.recordStatus.suspended',
  'statusCenter.recordStatus.unsubscribed',
  'statusCenter.recordStatus.processing',
  'statusCenter.recordStatus.delivered',
  'statusCenter.recordStatus.dead',
  'statusCenter.recordStatus.investigating',
  'statusCenter.recordStatus.identified',
  'statusCenter.recordStatus.monitoring',
  'statusCenter.recordStatus.resolved',
  'statusCenter.destination.email',
  'statusCenter.destination.webhook',
  'statusCenter.destination.discord',
  'statusCenter.actor.automation',
  'statusCenter.actor.admin',
  'statusCenter.actor.root',
  'statusCenter.actor.system',
  'statusCenter.empty.components',
  'statusCenter.empty.incidents',
  'statusCenter.empty.publishedUpdates',
  'statusCenter.empty.maintenance',
  'statusCenter.empty.subscribers',
  'statusCenter.empty.deliveries',
  'statusCenter.empty.settings',
  'statusCenter.empty.audit',
  ...
  'statusCenter.incidents.privateDraft.evidence',
