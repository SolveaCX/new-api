...
/**
 * The single group assigned to PLG users. The backend forces this group regardless
 * of what the client sends; the frontend also forces it so the group concept stays
 * hidden from PLG users.
 */
