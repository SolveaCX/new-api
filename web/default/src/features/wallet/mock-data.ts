...
export const MOCK_PLANS: LifecyclePlanRecord[] = [
  {
    plan: {
      ...
      window_5h_amount: 8_000_000,
      window_week_amount: 12_000_000,
      model_count: 100,
      rpm: 60,
      concurrency: 5,
  ...
  },
  {
    plan: {
      ...
      window_5h_amount: 18_000_000,
      window_week_amount: 45_000_000,
      model_count: 100,
      rpm: 120,
      concurrency: 10,
      feature_lines: '100+ models',
  ...
  },
  {
    plan: {
      ...
      window_5h_amount: 78_000_000,
      window_week_amount: 220_000_000,
      model_count: 100,
      rpm: 240,
      concurrency: 20,
      feature_lines: '100+ models',
