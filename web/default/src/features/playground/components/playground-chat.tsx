                                                ...
                                                ({ attachment, url }) =>
                                                  ...
                                                  url ? (
                                                    ...
                                                    <video
                                                      ...
                                                      className='border-border/70 max-h-80 max-w-full rounded-2xl border object-contain shadow-sm'
                                                      controls
                                                      key={`${message.key}-${version.id}-${attachment.filename}`}
                                                      preload='metadata'
                                                      src={url}
                                        ...
                                        {(textAttachmentPreviews.length > 0 ||
                                          ...
                                          >
                                            <div className='space-y-3'>
                                              ...
                                              {!!generatedMedia.length && (
                                                <div className='-my-1 grid max-w-3xl gap-3 sm:grid-cols-2'>
                                                  {generatedMedia.map(
                                                    (media, mediaIndex) => {
                                                      if (
                                                        media.type === 'video'
                                                        ...
                                                        return (
                                                          <video
                                                            className='bg-muted/50 border-border/70 max-h-[32rem] w-full rounded-2xl border object-contain shadow-sm'
                                                            controls
