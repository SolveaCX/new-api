...
for (const file of files) {
  ...
  if (!/fk2\.css\?v=722d/.test(html)) fail(file, "missing the current shared CSS cache version");
...
if (/body:has\(> header\.hero\)>\.nav/.test(sharedCss)) {
  fail("fk2.css", "contains a homepage-only navigation override instead of the shared Playground shell");
}
