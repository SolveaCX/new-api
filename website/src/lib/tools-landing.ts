import { LOCALES, type Locale, localizePath } from "./locales";
...
export const toolsLandingCopy: Record<Locale, ToolsLandingCopy> = {
  en: {
    ...
    heroBody: "Search, scrape, enrich, generate, and act—plus use 100+ AI models—through one Flatkey key and one prepaid balance.",
  ...
  zh: {
    ...
    heroAccent: "每一项工作",
    heroTail: "。",
    heroBody: "搜索、抓取、补全、生成、执行，加上 100+ AI 模型，全部使用一个 Flatkey Key 和一个预付余额。",
    ...
    stats: [{ value: "1,000+", label: "按量工具" }, { value: "100+", label: "AI 模型" }, { value: "1", label: "API Key 与余额" }, { value: "$0", label: "Flatkey 侧失败调用" }],
...
for (const locale of LOCALES) {
  toolsLandingCopy[locale].navLabel = localizedToolsNavLabels[locale];
}
