  ...
  es: {
    ...
    plans: {
      Starter: {
        ...
        bonus: "Recarga $10 y recibe $3 de bono",
        cta: "Suscribirse",
      },
      Pro: {
        audience: "Para desarrollo diario y solicitudes frecuentes",
        bonus: "Recarga $30 y recibe $15 de bono",
        cta: "Suscribirse",
      },
      Max: {
        audience: "Para equipos y cargas intensivas",
        bonus: "Recarga $100 y recibe $70 de bono",
        cta: "Suscribirse",
      },
    },
  ...
  fr: {
    ...
    plans: {
      Starter: {
        ...
        bonus: "Rechargez 10 $ et recevez 3 $ de bonus",
        cta: "S'abonner",
      },
      Pro: {
        audience: "Pour le développement quotidien et les requêtes fréquentes",
        bonus: "Rechargez 30 $ et recevez 15 $ de bonus",
        cta: "S'abonner",
      },
      Max: {
        audience: "Pour les équipes et les charges intensives",
        bonus: "Rechargez 100 $ et recevez 70 $ de bonus",
        cta: "S'abonner",
      },
    },
  ...
  pt: {
    ...
    plans: {
      Starter: {
        ...
        bonus: "Recarregue $10 e ganhe $3 de bônus",
        cta: "Assinar",
      },
      Pro: {
        audience: "Para desenvolvimento diário e solicitações frequentes",
        bonus: "Recarregue $30 e ganhe $15 de bônus",
        cta: "Assinar",
      },
      Max: {
        audience: "Para equipes e cargas intensas",
        bonus: "Recarregue $100 e ganhe $70 de bônus",
        cta: "Assinar",
      },
    },
  ...
  ru: {
    ...
    plans: {
      Starter: {
        ...
        bonus: "Пополните на $10 и получите бонус $3",
        cta: "Оформить",
      },
      Pro: {
        audience: "Для ежедневной разработки и частых запросов",
        bonus: "Пополните на $30 и получите бонус $15",
        cta: "Оформить",
      },
      Max: {
        audience: "Для команд и тяжёлых нагрузок",
        bonus: "Пополните на $100 и получите бонус $70",
        cta: "Оформить",
      },
    },
  ...
  ja: {
    ...
    plans: {
      Starter: {
        ...
        bonus: "$10 をチャージすると $3 ボーナス",
        cta: "登録する",
      },
      Pro: {
        audience: "日常的な開発と高頻度リクエスト向け",
        bonus: "$30 をチャージすると $15 ボーナス",
        cta: "登録する",
      },
      Max: {
        audience: "チームと高負荷ワークロード向け",
        bonus: "$100 をチャージすると $70 ボーナス",
        cta: "登録する",
      },
    },
  ...
  de: {
    ...
    plans: {
      Starter: {
        ...
        bonus: "$10 aufladen und $3 Bonus erhalten",
        cta: "Abonnieren",
      },
      Pro: {
        audience: "Für tägliche Entwicklung und häufige Anfragen",
        bonus: "$30 aufladen und $15 Bonus erhalten",
        cta: "Abonnieren",
      },
      Max: {
        audience: "Für Teams und hohe Workloads",
        bonus: "$100 aufladen und $70 Bonus erhalten",
        cta: "Abonnieren",
      },
    },
