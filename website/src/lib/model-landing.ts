...
export type ModelLandingKey =
  ...
  | "↓ Go $10 · Pro $30 · Max $100 per month — usage worth up to 1.7× the price"
  | "▶ Sign in to run"
  | "Start generating"
  | "Generator setup"
  | "Saved before signup"
  ...
  | "Best for"
  | "Same {{official}} upstream, same quality — plans from $10/month include every frontier model, with monthly usage worth up to 1.7× the price. Change one line of base_url and your existing OpenAI SDK just works. Try it below, sign in when you are ready."
  | "See plans →"
  | "Starter / individual"
  | "Team / high-volume"
  | "The same {{model}},"
  ...
  | "You get"
  | "of monthly model usage — 1.7× the price"
  | "from $10/month"
...
const en: Record<ModelLandingKey, string> = {
  ...
  "You get": "You get",
  "of monthly model usage — 1.7× the price": "of monthly model usage — 1.7× the price",
  "from $10/month": "from $10/month",
  "Pro — $30/mo, up to $45 usage": "Pro — $30/mo, up to $45 usage",
  "Most popular": "Most popular",
  "↓ Go $10 · Pro $30 · Max $100 per month — usage worth up to 1.7× the price": "↓ Go $10 · Pro $30 · Max $100 per month — usage worth up to 1.7× the price",
  ...
  "Best for": "Best for",
  "Same {{official}} upstream, same quality — plans from $10/month include every frontier model, with monthly usage worth up to 1.7× the price. Change one line of base_url and your existing OpenAI SDK just works. Try it below, sign in when you are ready.": "Same {{official}} upstream, same quality — plans from $10/month include every frontier model, with monthly usage worth up to 1.7× the price. Change one line of base_url and your existing OpenAI SDK just works. Try it below, sign in when you are ready.",
  "See plans →": "See plans →",
  "Starter / individual": "Starter / individual",
  "Team / high-volume": "Team / high-volume",
  "The same {{model}},": "The same {{model}},",
  "Go — $10/mo, up to $13 usage": "Go — $10/mo, up to $13 usage",
  "Max — $100/mo, up to $170 usage": "Max — $100/mo, up to $170 usage",
  "/ image": "/ image",
  "/ request": "/ request",
...
const translations: Record<Locale, Record<string, string>> = withIdFallback<Record<string, string>>({
  ...
  zh: {
    ...
    "You get": "你获得",
    "of monthly model usage — 1.7× the price": "每月模型可用量 —— 套餐价的 1.7 倍",
    "from $10/month": "只需 $10/月起",
    "Pro — $30/mo, up to $45 usage": "Pro —— $30/月，可用 $45",
    "Most popular": "最受欢迎",
    "↓ Go $10 · Pro $30 · Max $100 per month — usage worth up to 1.7× the price": "↓ Go $10 · Pro $30 · Max $100 每月 —— 可用量最高达套餐价 1.7 倍",
    ...
    "Same {{official}} upstream, same quality — plans from $10/month include every frontier model, with monthly usage worth up to 1.7× the price. Change one line of base_url and your existing OpenAI SDK just works. Try it below, sign in when you are ready.": "同款 {{official}} 上游，同等质量 —— $10/月起的套餐包含全部前沿模型，每月可用量最高达套餐价的 1.7 倍。只改一行 base_url，现有 OpenAI SDK 直接可用。先在下方试用，准备好再登录。",
    "See plans →": "查看套餐 →",
    "Starter / individual": "入门 / 个人",
    "Team / high-volume": "团队 / 大用量",
    "The same {{model}},": "同样的 {{model}}，",
    "Go — $10/mo, up to $13 usage": "Go —— $10/月，可用 $13",
    "Max — $100/mo, up to $170 usage": "Max —— $100/月，可用 $170",
    "/ image": "/ 张图片",
  ...
  es: {
    ...
    "You get": "Recibes",
    "of monthly model usage — 1.7× the price": "de uso mensual de modelos — 1.7× el precio",
    "from $10/month": "desde $10/mes",
    "Pro — $30/mo, up to $45 usage": "Pro — $30/mes, hasta $45 de uso",
    "Most popular": "Más popular",
    "↓ Go $10 · Pro $30 · Max $100 per month — usage worth up to 1.7× the price": "↓ Go $10 · Pro $30 · Max $100 al mes — uso de hasta 1.7× el precio",
    ...
    "Same {{official}} upstream, same quality — plans from $10/month include every frontier model, with monthly usage worth up to 1.7× the price. Change one line of base_url and your existing OpenAI SDK just works. Try it below, sign in when you are ready.": "Mismo upstream de {{official}}, misma calidad — los planes desde $10/mes incluyen todos los modelos frontera, con un uso mensual de hasta 1.7× lo que pagas. Cambia una línea de base_url y tu SDK de OpenAI existente simplemente funciona. Pruébalo abajo e inicia sesión cuando estés listo.",
    ...
    "Go — $10/mo, up to $13 usage": "Go — $10/mes, hasta $13 de uso",
    "Max — $100/mo, up to $170 usage": "Max — $100/mes, hasta $170 de uso",
  ...
  fr: {
    ...
    "of monthly model usage — 1.7× the price": "d'usage mensuel des modèles — 1,7× le prix",
    "from $10/month": "dès $10/mois",
    "Pro — $30/mo, up to $45 usage": "Pro — $30/mois, jusqu'à $45 d'usage",
    "Most popular": "Le plus populaire",
    "↓ Go $10 · Pro $30 · Max $100 per month — usage worth up to 1.7× the price": "↓ Go $10 · Pro $30 · Max $100 par mois — usage jusqu'à 1,7× le prix",
    ...
    "Same {{official}} upstream, same quality — plans from $10/month include every frontier model, with monthly usage worth up to 1.7× the price. Change one line of base_url and your existing OpenAI SDK just works. Try it below, sign in when you are ready.": "Même upstream {{official}}, même qualité — les plans dès $10/mois incluent tous les modèles frontière, avec un usage mensuel valant jusqu'à 1,7× le prix. Changez une ligne de base_url et votre SDK OpenAI existant fonctionne tel quel. Essayez ci-dessous, connectez-vous quand vous êtes prêt.",
    ...
    "Go — $10/mo, up to $13 usage": "Go — $10/mois, jusqu'à $13 d'usage",
    "Max — $100/mo, up to $170 usage": "Max — $100/mois, jusqu'à $170 d'usage",
  ...
  pt: {
    ...
    "You get": "Você recebe",
    "of monthly model usage — 1.7× the price": "de uso mensal de modelos — 1,7× o preço",
    "from $10/month": "a partir de $10/mês",
    "Pro — $30/mo, up to $45 usage": "Pro — $30/mês, até $45 de uso",
    "Most popular": "Mais popular",
    "↓ Go $10 · Pro $30 · Max $100 per month — usage worth up to 1.7× the price": "↓ Go $10 · Pro $30 · Max $100 por mês — uso de até 1,7× o preço",
    ...
    "Same {{official}} upstream, same quality — plans from $10/month include every frontier model, with monthly usage worth up to 1.7× the price. Change one line of base_url and your existing OpenAI SDK just works. Try it below, sign in when you are ready.": "Mesmo upstream da {{official}}, mesma qualidade — planos a partir de $10/mês incluem todos os modelos de fronteira, com uso mensal de até 1,7× o preço. Mude uma linha de base_url e seu SDK OpenAI existente simplesmente funciona. Teste abaixo e entre quando estiver pronto.",
    "See plans →": "Ver planos →",
    "Starter / individual": "Inicial / individual",
    "Team / high-volume": "Equipe / alto volume",
    "The same {{model}},": "O mesmo {{model}},",
    "Go — $10/mo, up to $13 usage": "Go — $10/mês, até $13 de uso",
    "Max — $100/mo, up to $170 usage": "Max — $100/mês, até $170 de uso",
  ...
  ru: {
    ...
    "of monthly model usage — 1.7× the price": "месячного использования моделей — 1,7× цены",
    "from $10/month": "от $10/мес",
    "Pro — $30/mo, up to $45 usage": "Pro — $30/мес, до $45 использования",
    "Most popular": "Самый популярный",
    "↓ Go $10 · Pro $30 · Max $100 per month — usage worth up to 1.7× the price": "↓ Go $10 · Pro $30 · Max $100 в месяц — использование до 1,7× цены",
    ...
    "Same {{official}} upstream, same quality — plans from $10/month include every frontier model, with monthly usage worth up to 1.7× the price. Change one line of base_url and your existing OpenAI SDK just works. Try it below, sign in when you are ready.": "Тот же upstream {{official}}, то же качество — планы от $10/мес включают все передовые модели, с месячным использованием до 1,7× цены. Измените одну строку base_url — и ваш существующий OpenAI SDK просто работает. Попробуйте ниже, войдите, когда будете готовы.",
    ...
    "Go — $10/mo, up to $13 usage": "Go — $10/мес, до $13 использования",
    "Max — $100/mo, up to $170 usage": "Max — $100/мес, до $170 использования",
  ...
  ja: {
    ...
    "You get": "使えるのは",
    "of monthly model usage — 1.7× the price": "月間モデル利用枠——料金の 1.7 倍",
    "from $10/month": "月額 $10 から",
    "Pro — $30/mo, up to $45 usage": "Pro — $30/月、利用枠 $45",
    "Most popular": "一番人気",
    "↓ Go $10 · Pro $30 · Max $100 per month — usage worth up to 1.7× the price": "↓ Go $10 · Pro $30 · Max $100 /月——利用枠は料金の最大 1.7 倍",
    ...
    "Same {{official}} upstream, same quality — plans from $10/month include every frontier model, with monthly usage worth up to 1.7× the price. Change one line of base_url and your existing OpenAI SDK just works. Try it below, sign in when you are ready.": "同じ {{official}} アップストリーム、同じ品質——月額 $10 からのプランで全フロンティアモデルが使え、月間利用枠は料金の最大 1.7 倍。base_url を 1 行変えるだけで、既存の OpenAI SDK がそのまま動きます。まず下で試して、準備ができたらログインを。",
    "See plans →": "プランを見る →",
    "Starter / individual": "スターター / 個人",
    "Team / high-volume": "チーム / 大量利用",
    "The same {{model}},": "同じ {{model}}、",
    "Go — $10/mo, up to $13 usage": "Go — $10/月、利用枠 $13",
    "Max — $100/mo, up to $170 usage": "Max — $100/月、利用枠 $170",
  ...
  vi: {
    ...
    "You get": "Bạn nhận",
    "of monthly model usage — 1.7× the price": "mức dùng model hằng tháng — 1,7× giá",
    "from $10/month": "từ $10/tháng",
    "Pro — $30/mo, up to $45 usage": "Pro — $30/tháng, dùng tới $45",
    "Most popular": "Phổ biến nhất",
    "↓ Go $10 · Pro $30 · Max $100 per month — usage worth up to 1.7× the price": "↓ Go $10 · Pro $30 · Max $100 mỗi tháng — mức dùng tới 1,7× giá",
    ...
    "Same {{official}} upstream, same quality — plans from $10/month include every frontier model, with monthly usage worth up to 1.7× the price. Change one line of base_url and your existing OpenAI SDK just works. Try it below, sign in when you are ready.": "Cùng upstream {{official}}, cùng chất lượng — các gói từ $10/tháng bao gồm mọi model tiên phong, với mức dùng hằng tháng lên tới 1,7× giá gói. Đổi một dòng base_url và SDK OpenAI hiện có của bạn chạy ngay. Thử bên dưới, đăng nhập khi sẵn sàng.",
    "See plans →": "Xem các gói →",
    "Starter / individual": "Khởi đầu / cá nhân",
    "Team / high-volume": "Nhóm / khối lượng lớn",
    "The same {{model}},": "Cùng {{model}},",
    "Go — $10/mo, up to $13 usage": "Go — $10/tháng, dùng tới $13",
    "Max — $100/mo, up to $170 usage": "Max — $100/tháng, dùng tới $170",
  ...
  de: {
    ...
    "of monthly model usage — 1.7× the price": "monatliche Modellnutzung — das 1,7-Fache des Preises",
    "from $10/month": "ab $10/Monat",
    "Pro — $30/mo, up to $45 usage": "Pro — $30/Monat, bis zu $45 Nutzung",
    "Most popular": "Am beliebtesten",
    "↓ Go $10 · Pro $30 · Max $100 per month — usage worth up to 1.7× the price": "↓ Go $10 · Pro $30 · Max $100 pro Monat — Nutzung bis zum 1,7-Fachen des Preises",
    ...
    "Same {{official}} upstream, same quality — plans from $10/month include every frontier model, with monthly usage worth up to 1.7× the price. Change one line of base_url and your existing OpenAI SDK just works. Try it below, sign in when you are ready.": "Gleicher {{official}}-Upstream, gleiche Qualität — Pläne ab $10/Monat enthalten alle Frontier-Modelle, mit monatlichem Nutzungswert bis zum 1,7-Fachen des Preises. Ändern Sie eine Zeile base_url und Ihr bestehendes OpenAI SDK funktioniert einfach. Unten ausprobieren, anmelden, wenn Sie bereit sind.",
    ...
    "Go — $10/mo, up to $13 usage": "Go — $10/Monat, bis zu $13 Nutzung",
    "Max — $100/mo, up to $170 usage": "Max — $100/Monat, bis zu $170 Nutzung",
    "Opus 4 output": "Opus 4 Output",
    "Sonnet 4 output": "Sonnet 4 Output",
    "Haiku output": "Haiku Output",
    "GPT-5 output": "GPT-5 Output",
...
const modelDetailResidualCopy: Record<Locale, Record<string, string>> = {
  ...
  id: {
    ...
    "↓ Go $10 · Pro $30 · Max $100 per month — usage worth up to 1.7× the price": "↓ Go $10 · Pro $30 · Max $100 per bulan — penggunaan hingga 1,7× harga",
    ...
    "Same {{official}} upstream, same quality — plans from $10/month include every frontier model, with monthly usage worth up to 1.7× the price. Change one line of base_url and your existing OpenAI SDK just works. Try it below, sign in when you are ready.": "Upstream {{official}} yang sama, kualitas yang sama — paket mulai $10/bulan mencakup semua model terdepan, dengan penggunaan bulanan hingga 1,7× harga. Ubah satu baris base_url dan SDK OpenAI Anda langsung berfungsi. Coba di bawah, lalu masuk saat siap.",
    ...
    "of monthly model usage — 1.7× the price": "penggunaan model bulanan — 1,7× harga",
    "from $10/month": "mulai $10/bulan",
    "Pro — $30/mo, up to $45 usage": "Pro — $30/bln, penggunaan hingga $45",
    "Most popular": "Paling populer",
    "Go — $10/mo, up to $13 usage": "Go — $10/bln, penggunaan hingga $13",
    "Max — $100/mo, up to $170 usage": "Max — $100/bln, penggunaan hingga $170",
