...
const translations: Record<Locale, Record<string, string>> = withIdFallback<Record<string, string>>({
  ...
  es: {
    ...
    "Average per request": "Promedio por petición",
  ...
  fr: {
    ...
    "Average per request": "Moyenne par requête",
  ...
  pt: {
    ...
    "Average per request": "Média por requisição",
  ...
  ru: {
    ...
    "Average per request": "В среднем на запрос",
  ...
  ja: {
    ...
    "Average per request": "1 リクエストあたり平均",
  ...
  vi: {
    ...
    "Average per request": "Trung bình mỗi yêu cầu",
  ...
  de: {
    ...
    "Generation time": "Generierungsdauer",
    "Average per request": "Durchschnitt pro Anfrage",
...
const supplementalModelLandingCopy: Partial<Record<Locale, Partial<Record<string, string>>>> = {
  ...
  id: {
    ...
    "Average per request": "Rata-rata per permintaan",
