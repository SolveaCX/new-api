...
export const MIXPANEL_BROWSER_SCRIPT = `(function(){
  function runWhenIdle(fn){if("requestIdleCallback" in window){window.requestIdleCallback(fn,{timeout:3000});return;}setTimeout(fn,1500)}
  function isLocalhost(){var h=window.location.hostname;return h==="localhost"||h==="127.0.0.1"||h==="::1"}
