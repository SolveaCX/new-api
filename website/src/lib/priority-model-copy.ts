...
const MINIMAX_REFERENCE_BODY: Record<Locale, string> = {
  ...
  es: "MiniMax documenta entradas de texto, imagen, vídeo y audio: hasta 9 imágenes, 3 clips de vídeo, 3 clips de audio o 12 archivos mixtos; el prompt está limitado a 7.000 caracteres en el upstream. Los campos de Flatkey pueden variar según la ruta.",
  fr: "MiniMax documente des entrées texte, image, vidéo et audio : jusqu’à 9 images, 3 clips vidéo, 3 clips audio ou 12 fichiers mixtes ; le prompt est limité à 7 000 caractères en amont. Les champs Flatkey peuvent varier selon la route.",
  pt: "A MiniMax documenta entradas de texto, imagem, vídeo e áudio: até 9 imagens, 3 clipes de vídeo, 3 clipes de áudio ou 12 arquivos mistos; o prompt é limitado a 7.000 caracteres no upstream. Os campos da Flatkey podem variar conforme a rota.",
  ru: "MiniMax документирует текстовые, графические, видео- и аудиовходы: до 9 изображений, 3 видеофрагментов, 3 аудиофрагментов или 12 смешанных файлов; upstream ограничивает промпт 7000 символами. Поля Flatkey могут различаться по маршрутам.",
  ...
  vi: "MiniMax ghi nhận đầu vào văn bản, hình ảnh, video và âm thanh: tối đa 9 ảnh, 3 clip video, 3 clip âm thanh hoặc 12 tệp hỗn hợp; upstream giới hạn prompt ở 7.000 ký tự. Trường Flatkey có thể khác theo route.",
  de: "MiniMax dokumentiert Text-, Bild-, Video- und Audioeingaben mit bis zu 9 Bildern, 3 Videoclips, 3 Audioclips oder 12 gemischten Dateien; upstream begrenzt Prompts auf 7.000 Zeichen. Flatkey-Felder können je nach Pfad abweichen.",
  id: "MiniMax mendokumentasikan input teks, gambar, video, dan audio: hingga 9 gambar, 3 klip video, 3 klip audio, atau 12 file campuran; upstream membatasi prompt hingga 7.000 karakter. Kolom Flatkey dapat berbeda menurut rute.",
};
