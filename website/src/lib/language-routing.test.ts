...
describe("language routing", () => {
  test("resolves supported languages from Accept-Language", () => {
    ...
    expect(resolvePreferredLocale(undefined, "hi-IN,hi;q=0.9,en;q=0.8")).toBe("hi");
  });
  ...
  test("redirects ordinary users on non-locale public pages", () => {
    ...
    expect(getLanguageRedirectPath({ pathname: "/pricing", method: "GET", acceptLanguage: "hi-IN,hi;q=0.9" })).toBe("/hi/pricing");
