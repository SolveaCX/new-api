...
const copies: Record<Locale, BaseCopy> = withIdFallback({
  ...
  id: {
    nav: {
      ...
      app: "Buka aplikasi",
      signIn: "Masuk",
      toggle: "Buka/tutup menu navigasi",
      toggleTheme: "Ubah tema",
      light: "Terang",
      dark: "Gelap",
      system: "Sistem",
      notifications: "Notifikasi",
      systemAnnouncements: "Pengumuman sistem",
      latestPlatformUpdates: "Pembaruan dan pemberitahuan platform terbaru",
      notice: "Pemberitahuan",
      timeline: "Linimasa",
      noAnnouncements: "Belum ada pengumuman",
      noSystemAnnouncements: "Tidak ada pengumuman sistem",
      loading: "Memuat...",
      close: "Tutup",
    },
    home: {
      title: "Model GPT, Claude, dan Gemini resmi — hingga 50% lebih murah",
      description: "flatkey.ai merutekan traffic Anda ke API resmi GPT, Claude, dan Gemini melalui satu key. Model yang sama, hingga setengah harga resmi dengan diskon bertumpuk, serta kesehatan live 30 hari untuk setiap model.",
      primary: "Dapatkan key",
      secondary: "Lihat harga",
      hero: {
        badge: "Kompatibel dengan banyak model, siap untuk enterprise",
        titleLine1: "Setiap model.",
        titleLine2: "Satu key. Tarif flat.",
        toolsLabel: "Bekerja dengan tools Anda saat ini",
        toolsDescription: "Mendukung konfigurasi sekali klik dan beradaptasi dengan konfigurasi multi-protokol NewAPI.",
        moreApps: "Aplikasi lainnya",
      },
      stats: { items: [
        { value: "200+", label: "model di balik satu key" },
        { value: "1", label: "base URL yang kompatibel dengan OpenAI" },
        { value: "24/7", label: "visibilitas penggunaan dan tagihan" },
        { value: "1", label: "dashboard untuk key dan routing" },
      ] },
      features: {
        eyebrow: "Mengapa flatkey",
        titleLine1: "Satu tempat untuk akses,",
        titleLine2: "harga, dan kendali",
        items: [
          { title: "Akses sekali klik", desc: "Dapatkan satu API key dan panggil setiap model AI yang terhubung tanpa mendaftar ke tiap provider secara terpisah." },
          { title: "Stabil dan andal", desc: "Routing cerdas di berbagai akun upstream dengan failover otomatis dan load balancing untuk menghindari error yang sering terjadi." },
          { title: "Bayar sesuai pemakaian", desc: "Bayar berdasarkan pemakaian nyata, tetapkan batas kuota, dan pantau konsumsi tim dengan jelas." },
        ],
      },
      models: { title: "Model AI pilihan", description: "Model unggulan pilihan komunitas flatkey", tag: "teks ke teks" },
      about: {
        eyebrow: "Tentang flatkey.ai",
        title: "Lapisan API terpadu untuk produk AI modern",
        description: "flatkey.ai menyediakan software terkelola dan saldo prabayar untuk penggunaan API AI berbasis pemakaian. Biaya dihitung dari harga input, output, dan cache-hit model dikalikan penggunaan token.",
        items: [
          { title: "Apa itu flatkey.ai", desc: "flatkey.ai adalah gateway API AI terpadu untuk memanggil model AI yang didukung dengan satu API key, satu base URL, dan satu dashboard." },
          { title: "Masalah yang diselesaikan", desc: "Mengurangi akun provider terpisah, API key yang tersebar, routing yang tidak konsisten, dan pelacakan penggunaan yang terfragmentasi." },
          { title: "Siapa yang menggunakannya", desc: "Untuk developer, tim produk AI, pembuat otomatisasi, dan tim operasi yang membutuhkan akses terprediksi ke banyak model." },
        ],
      },
      productHighlights: {
        eyebrow: "Fokus produk",
        title: "Dibuat untuk tim yang merilis fitur AI",
        description: "flatkey menyatukan akses model, routing, billing, dan kebijakan penggunaan agar tim bergerak lebih cepat tanpa mengelola provider tambahan.",
        items: [
          { title: "Tim produk AI", desc: "Tambahkan akses model ke produk tanpa mengelola akun provider, key, dan perubahan SDK secara terpisah." },
          { title: "Operasi dan keuangan", desc: "Pantau pengeluaran token, riwayat top-up, dan penggunaan tim dalam satu dashboard." },
          { title: "Pembuat otomatisasi", desc: "Route workflow bervolume tinggi ke model yang tepat dan tinjau error serta biaya dengan mudah." },
          { title: "Evaluasi dan iterasi model", desc: "Bandingkan provider, ganti model, dan tetap gunakan client yang kompatibel dengan OpenAI pada base URL yang sama." },
        ],
      },
      howItWorks: {
        eyebrow: "Cara semuanya terhubung",
        title: "Dari homepage ke panggilan produksi",
        steps: [
          { num: "1", title: "Dapatkan satu key", desc: "Buat akun flatkey, buka dashboard, dan hasilkan API key untuk aplikasi Anda." },
          { num: "2", title: "Ubah base URL", desc: "Arahkan client yang kompatibel dengan OpenAI ke {{apiBaseUrl}} dan pertahankan SDK Anda." },
          { num: "3", title: "Pantau dan optimalkan", desc: "Tinjau penggunaan, biaya, routing, dan error dari dashboard produk yang sama." },
        ],
      },
      cta: { titleLine1: "Siap mengganti", titleLine2: "kekacauan model dengan satu key?", description: "Mulai dari homepage flatkey, kelola dashboard produk, dan gunakan {{host}} sebagai endpoint API yang stabil." },
      terminal: {
        request: "Permintaan", response: "Respons", cost: "Biaya", tokens: "token", ms: "ms",
        responses: { "gpt-chat": "Permintaan chat dirutekan.", responses: "Workflow respons siap.", claude: "Pesan Claude dirutekan.", gemini: "Permintaan Gemini diproses." },
      },
    },
    footer: {
      tagline: "Aman, andal, terjangkau",
      trustedVerifiedBy: "DIPERCAYA & TERVERIFIKASI OLEH",
      emailSupport: "Email: support@flatkey.ai",
      termsOfService: "Ketentuan layanan",
      privacyPolicy: "Kebijakan privasi",
      serviceLevelAgreement: "Perjanjian tingkat layanan",
      refundPolicy: "Kebijakan pengembalian dana",
      supportEmail: "Dukungan: support@flatkey.ai",
      defaultCopyright: "Hak cipta dilindungi.",
      projectAttributionSuffix: "Gateway API AI dan platform operasi model.",
    },
  },
});
