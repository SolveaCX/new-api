  ...
  return (
    <OnlineStaticShell locale={props.locale} pathname="/">
      <style>{`
        ...
        @media(max-width:1100px){.compactHero h1.display{font-size:clamp(44px,6.3vw,68px)!important}.modelStripItem{gap:10px}.modelStripItem strong{font-size:13px}.modelStripItem span{font-size:11px}}
