...
const PRICING_COPY: Record<Locale, PricingPageBaseCopy> =withIdFallback({
  en: {
    ...
    getFreeApiKey: "Get up to $40 free credits",
  ...
  es: {
    ...
    getFreeApiKey: "Obtén hasta $40 en créditos gratis",
  ...
  fr: {
    ...
    getFreeApiKey: "Recevoir jusqu'à 40 $ de crédits gratuits",
  ...
  pt: {
    ...
    getFreeApiKey: "Ganhe até US$40 em créditos grátis",
  ...
  ru: {
    ...
    getFreeApiKey: "Получите до $40 бесплатных кредитов",
  ...
  ja: {
    ...
    getFreeApiKey: "最大 $40 の無料クレジットを獲得",
  ...
  vi: {
    ...
    getFreeApiKey: "Nhận tới $40 credit miễn phí",
  ...
  de: {
    ...
    getFreeApiKey: "Bis zu $40 Gratisguthaben erhalten",
    enterpriseTeams: "Enterprise-Teams",
