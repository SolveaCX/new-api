  ...
  return (
    <SiteShell locale={props.locale} pathname={content.pathname}>
      <main className="bg-[#FAFAFC] text-[#0B0B0F]">
        <section className="border-b border-[#0B0B0F14] bg-[radial-gradient(900px_360px_at_50%_-90px,#EEE9FF,transparent_70%)] px-[var(--fk-site-gutter)] pt-18 pb-12 md:pt-24 md:pb-16">
          <div className="mx-auto max-w-[var(--fk-site-max-width)] text-center">
        ...
        <section className="px-[var(--fk-site-gutter)] py-10">
          <div className="mx-auto grid max-w-[var(--fk-site-max-width)] gap-4 md:grid-cols-3">
        ...
        <section className="px-[var(--fk-site-gutter)] pb-16 md:pb-24">
          <div className="mx-auto grid max-w-[var(--fk-site-max-width)] gap-4 lg:grid-cols-3">
