        ...
        <div className="tiers">
          {displayedPlans.map((plan) => {
            ...
            <div className={`tier${plan.hot ? " hot" : ""}${plan.limitedOffer ? " limited-offer" : ""}`} key={plan.name}>
              ...
              <div className="tdiscount">{plan.discountLabel}</div>
