  ...
  return (
    <>
      ...
      <div className="wrap">
        ...
        <section className="direct-topup" aria-labelledby="direct-topup-title">
          <div className="direct-topup-main" style={{ display: "flex", alignItems: "center", gap: 16, minWidth: 0 }}>
            <span className="direct-topup-icon" aria-hidden="true" style={{ display: "grid", placeItems: "center", flex: "none", width: 48, height: 48, borderRadius: "50%", color: "var(--violet-deep)", background: "var(--violet-tint)" }}><Wallet2 size={18} /></span>
            <div><h2 id="direct-topup-title">{directTopUp.title}</h2><p>{directTopUp.body}</p></div>
          </div>
          <a className="btn black direct-topup-cta" href={consoleUrl("/wallet")}>{directTopUp.cta} <span aria-hidden="true">↗</span></a>
        </section>
        <div className="tiers">
