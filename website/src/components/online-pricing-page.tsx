        ...
        <div className="tiers">
          {displayedPlans.map((plan) => {
            ...
            <div className={`tier${plan.hot ? " hot" : ""}`} key={plan.name}>
              ...
              <div className="tdiscount">{copy.pricing.discountLabel}</div>
