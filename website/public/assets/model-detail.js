(function () {
  ...
  root.innerHTML = '<section class="model-hero">' +
    ...
    '<div class="hero-actions">' + (status.id === "available" || status.id === "early_access" ? '<a class="btn black" href="https://console.flatkey.ai/dashboard">Get API Key →</a><a class="btn white" href="/playground?model=' + encodeURIComponent(slug) + '">Try in Playground</a>' : '<a class="btn black" href="/contact">Request access →</a>') + '</div></section>' +
