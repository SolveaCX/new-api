	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/topup", middleware.CriticalRateLimit(), middleware.PaymentRateLimit(), controller.TopUp)
				selfRoute.POST("/pay", middleware.CriticalRateLimit(), middleware.PaymentRateLimit(), controller.RequestEpay)
				selfRoute.POST("/amount", controller.RequestAmount)
				selfRoute.POST("/stripe/pay", middleware.CriticalRateLimit(), middleware.PaymentRateLimit(), controller.RequestStripePay)
				...
				selfRoute.POST("/creem/pay", middleware.CriticalRateLimit(), middleware.PaymentRateLimit(), controller.RequestCreemPay)
				selfRoute.POST("/waffo/amount", controller.RequestWaffoAmount)
				selfRoute.POST("/waffo/pay", middleware.CriticalRateLimit(), middleware.PaymentRateLimit(), controller.RequestWaffoPay)
				selfRoute.POST("/waffo-pancake/amount", controller.RequestWaffoPancakeAmount)
				selfRoute.POST("/waffo-pancake/pay", middleware.CriticalRateLimit(), middleware.PaymentRateLimit(), controller.RequestWaffoPancakePay)
				selfRoute.POST("/paddle/amount", controller.RequestPaddleAmount)
				selfRoute.POST("/paddle/pay", middleware.CriticalRateLimit(), middleware.PaymentRateLimit(), controller.RequestPaddlePay)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/balance/pay", middleware.CriticalRateLimit(), middleware.PaymentRateLimit(), controller.SubscriptionRequestBalancePay)
			subscriptionRoute.POST("/epay/pay", middleware.CriticalRateLimit(), middleware.PaymentRateLimit(), controller.SubscriptionRequestEpay)
			subscriptionRoute.POST("/stripe/pay", middleware.CriticalRateLimit(), middleware.PaymentRateLimit(), controller.SubscriptionRequestStripePay)
			subscriptionRoute.POST("/creem/pay", middleware.CriticalRateLimit(), middleware.PaymentRateLimit(), controller.SubscriptionRequestCreemPay)
