...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.POST("/registration/email-verification/status", middleware.CriticalRateLimit(), anonymousRequestBodyLimit, controller.GetRegistrationEmailVerificationStatus)
