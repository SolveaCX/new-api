	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/topup/:trade_no/resume", middleware.CriticalRateLimit(), middleware.RequireSelfServicePayment(), controller.ResumeStripeTopUpCheckout)
				...
				selfRoute.POST("/pay", middleware.CriticalRateLimit(), middleware.RequireSelfServicePayment(), controller.RequestEpay)
				selfRoute.POST("/amount", controller.RequestAmount)
				selfRoute.POST("/stripe/pay", middleware.CriticalRateLimit(), middleware.RequireSelfServicePayment(), controller.RequestStripePay)
				selfRoute.POST("/stripe/amount", controller.RequestStripeAmount)
				selfRoute.POST("/stripe/checkout/discount", middleware.CriticalRateLimit(), middleware.RequireSelfServicePayment(), controller.UpdateStripeCheckoutDiscount)
				selfRoute.POST("/stripe/checkout/close", middleware.CriticalRateLimit(), controller.CloseStripeCheckout)
				...
				selfRoute.POST("/creem/pay", middleware.CriticalRateLimit(), middleware.RequireSelfServicePayment(), controller.RequestCreemPay)
				selfRoute.POST("/waffo/amount", controller.RequestWaffoAmount)
				selfRoute.POST("/waffo/pay", middleware.CriticalRateLimit(), middleware.RequireSelfServicePayment(), controller.RequestWaffoPay)
				selfRoute.POST("/waffo-pancake/amount", controller.RequestWaffoPancakeAmount)
				selfRoute.POST("/waffo-pancake/pay", middleware.CriticalRateLimit(), middleware.RequireSelfServicePayment(), controller.RequestWaffoPancakePay)
				selfRoute.POST("/paddle/amount", controller.RequestPaddleAmount)
				selfRoute.POST("/paddle/pay", middleware.CriticalRateLimit(), middleware.RequireSelfServicePayment(), controller.RequestPaddlePay)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/self/quote", middleware.SubscriptionPaymentRateLimit(), middleware.RequireSelfServicePayment(), controller.QuoteSubscriptionSelfPurchase)
			subscriptionRoute.POST("/self/purchase", middleware.SubscriptionPaymentRateLimit(), middleware.RequireSelfServicePayment(), controller.PurchaseSubscriptionSelf)
			subscriptionRoute.POST("/self/change-plan", middleware.SubscriptionPaymentRateLimit(), middleware.RequireSelfServicePayment(), controller.ChangeSubscriptionPlan)
			subscriptionRoute.POST("/self/renewal/cancel", middleware.CriticalRateLimit(), controller.CancelSubscriptionRenewal)
			subscriptionRoute.POST("/self/renewal/resume", middleware.CriticalRateLimit(), middleware.RequireSelfServicePayment(), controller.ResumeSubscriptionRenewal)
			subscriptionRoute.POST("/balance/pay", middleware.CriticalRateLimit(), middleware.RequireSelfServicePayment(), controller.SubscriptionRequestBalancePay)
			subscriptionRoute.POST("/epay/pay", middleware.CriticalRateLimit(), middleware.RequireSelfServicePayment(), controller.SubscriptionRequestEpay)
			subscriptionRoute.POST("/stripe/pay", middleware.CriticalRateLimit(), middleware.RequireSelfServicePayment(), controller.SubscriptionRequestStripePay)
			subscriptionRoute.POST("/creem/pay", middleware.CriticalRateLimit(), middleware.RequireSelfServicePayment(), controller.SubscriptionPurchasePendingMigration)
			subscriptionRoute.POST("/waffo-pancake/pay", middleware.CriticalRateLimit(), middleware.RequireSelfServicePayment(), controller.SubscriptionPurchasePendingMigration)
		}
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.POST("/translate-announcement", controller.TranslateAnnouncement)
